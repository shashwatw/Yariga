...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    ...
    <Box mt="20px" borderRadius="15px" padding="20px" bgcolor="#292929">
      <Box
        sx={{
          display: "flex",
          ...
          >
            ...
            >
              <Stack direction="column">
                <Typography fontSize={22} fontWeight={600} color="#70a6ff">
                  {name}
                </Typography>
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box
                    ...
                    gap="10px"
                  >
                    <Place sx={{ color: "#48486E" }} />
                    <Typography fontSize={14} color="#70a6ff">
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    ...
                    <Box
                      ...
                      gap="10px"
                    >
                      <Phone sx={{ color: "#48486E" }} />
                      <Typography fontSize={14} color="#70a6ff" noWrap>
                        +0123 456 7890
                      </Typography>
                    </Box>
                  </Stack>
    ...
    {properties.length > 0 && (
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#292929">
        <Typography fontSize={18} fontWeight={600} color="#a9aaba">
          {type} Properties
        </Typography>
